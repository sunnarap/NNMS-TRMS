...
--INSERT INTO USERS VALUES (USERIDSEQUENCE.NEXTVAL, 'BOB', 'ROSS', 'EMAIL@EMAIL.GOV', 'PASSWORD', (SELECT TID FROM USER_TITLE WHERE TID = 1));
EXECUTE CREATE_USER(USERIDSEQUENCE.NEXTVAL, 'BOB', 'ROSS', 'EMAIL@EMAIL.COM', 'PASSWORD', 1);
...
L_NAME IN VARCHAR2,E_MAIL IN VARCHAR2,PASS_WORD IN VARCHAR2, T_ID IN NUMBER)
AS BEGIN
